          ...
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <form action="#" method="POST" className="mt-8">
              <div className="space-y-5">
                ...
                <input
                      className="flex h-10 w-50 rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                      type="password"
                      placeholder="OTP"
                      id="password"
                 ...
                 <button
                    type="button"
                    className="inline-flex h-10 w-40 items-center justify-center rounded-md border border-black px-3.5 py-2.5 font-semibold leading-7 text-black hover:bg-slate-600"
                    onClick={generate_send_otp}
                  >
                    Generate OTP <ArrowRight size={16} />
                  </button>
                </div>
                <div>
                  <button
